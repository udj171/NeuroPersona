  ...
  const RegistrationForm = {
    ...
    async handleSubmit(event) {
      ...
      try {
        ...
        // Create user via API
        const response = await EFOPAApiClient.createUser(formState.registrationData);
  ...
  const Questionnaire = {
    ...
    async submitAssessment() {
      ...
      try {
        ...
        const response = await EFOPAApiClient.submitAssessment({
  ...
  const ResultsPage = {
    ...
    async init() {
      try {
        ...
        const response = await EFOPAApiClient.getAssessmentResults({
